...
## Other notes
Again this project is experimental, and not all things will work perfectly. This project has been an interesing learning experience, but unless you really want a linux handheld, I would suggest buying an AYN Thor. If you are interested in how these devices are designed however, I encourage you check out the schematics above. Most of all, its cool that individual people can now make full products, and if you're thinking about doing someting similar, I highly reccomend the experience.
